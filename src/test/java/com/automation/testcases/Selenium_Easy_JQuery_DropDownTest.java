...
import com.automation.pageobjects.MainJQueryDropDownPage;
...
public class Selenium_Easy_JQuery_DropDownTest extends TestBase{
	
		
	public static final Logger APP_LOGS=Logger.getLogger(Selenium_Easy_JQuery_DropDownTest.class.getName());
	MainJQueryDropDownPage mainjquerydropdown;
	...
	public  void ValidateJQuerySelectDropdownPage(){
		...
		mainjquerydropdown = new MainJQueryDropDownPage(driver);
